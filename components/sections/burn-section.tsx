...
export function BurnSection() {
  ...
  return (
    <section
      id="burn"
      className="relative w-full bg-background py-24 px-4 md:px-8 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <WordReveal
            text="Click. Burn. Repeat."
            as="h2"
            className="block text-4xl md:text-6xl font-bold fire-text mb-4 leading-[1.05]"
          />
        ...
        <div className="fire-ring rounded-2xl">
          <Card className="relative w-full overflow-hidden border-ember-700/30 bg-black/85 ember-glow">
